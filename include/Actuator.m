...
classdef Actuator < handle
    ...
    methods 
        function obj = Actuator(sim_start, Odometry)
            obj.current  = sim_start;
            obj.Odometry = Odometry;
            obj.dt       = 0.02;
        end
        
        function [t, u] = control(obj)
            t =  obj.Odometry(obj.current, 1);
            u = [obj.Odometry(obj.current, 2:3), obj.dt]';

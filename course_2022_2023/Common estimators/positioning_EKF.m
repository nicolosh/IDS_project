...
% measurement
R = blkdiag(0.1, 0.7 * eye(height(anchors)));
z = [attitude, distance] + mvnrnd(zeros(1, height(R)), R, N);
...
error_pos_x = path(:,1) - x(1,:)';
error_pos_y = path(:,2) - x(2,:)';
